...
<div class="main-content-inner">
    <div class="content-header-title">
        <h2 style="color: #2E7D32; font-weight: 700;">Tambah Pengguna Baru</h2>
        <p style="color: #666;">Buat akun admin atau super admin baru dengan mudah.</p>
    </div>
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(strlen($pass) < 6){
                        ...
                        if(mysqli_num_rows($cek) > 0){
                            ...
                            if($simpan){
                                echo '<div class="alert-success" style="background: #e8f5e9; color: #2E7D32; padding: 12px; border-radius: 10px; border: 1px solid #c8e6c9; margin-bottom: 20px;">✅ Pengguna berhasil dibuat!</div>';
                                echo "<script>setTimeout(() => window.location='pengguna.php?success=User baru berhasil dibuat', 2000);</script>";
                            } else {
...
<?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="input-control" placeholder="Masukkan nama lengkap admin" required>
                </div>

                <div class="form-group">
                    <label style="font-weight: bold;">Username</label>
                    <input type="text" name="user" class="input-control" placeholder="Username unik (tanpa spasi)" required>
                </div>
                ...
                <div style="margin-top: 25px;">
                    <button type="submit" name="submit" class="btn-submit" style="width: 100%; padding: 14px; background: #2E7D32; border: none; border-radius: 10px; color: white; font-weight: 600; font-size: 16px;">
                        <i class="fa fa-user-plus"></i> Buat Pengguna Baru
                    </button>
